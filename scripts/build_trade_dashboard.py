...
APP_JS = _SHARED_JS + "\n" + "\n".join((ASSET_DIR / name).read_text(encoding="utf-8") for name in ("backfill-progress.js", "investor-evidence.js", "personal-reviews.js", "operations.js", "source-ocr.js", "app.js"))
